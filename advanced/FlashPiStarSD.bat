@echo off
:: HolyConnect - advanced helper: force a full Pi-Star SD flash
:: Most users should use ..\HolyConnect-Run-First.bat instead.

setlocal
set "PS_EXE=%SystemRoot%\System32\WindowsPowerShell\v1.0\powershell.exe"
set "TARGET_PS1=%~dp0..\FlashPiStarSD.ps1"
cd /d "%~dp0.."
...
if %errorlevel% neq 0 (
    echo Advanced helper: force full Pi-Star SD flash / Helper avancado: forcar gravacao completa do SD Pi-Star
