...
if ($Lang -eq 'pt') {
    ...
    $T.PrepareSdHint     = "Se o cartao SD ainda estiver stock, usa HolyConnect-Run-First.bat uma vez antes de usar o HolyConnect."
    $T.Detected          = "Detetado"
    ...
    $T.PrepareSdHint     = "If the SD card is still stock, use HolyConnect-Run-First.bat once before using HolyConnect."
    $T.Detected          = "Detected"
